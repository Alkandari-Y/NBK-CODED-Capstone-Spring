...
class DataSeeder(
    ...
    fun seedAccountProducts() {
            // 1. Basic Credit Card – For Low-Income
            ...
            // 2. Standard Credit Card – For Middle-Income
            ...
            // 3. Premium Credit Card – For High-Income
            ...
            // 4. Debit Card – No Credit, No Fees
            val debitCard = AccountProductEntity(
                id = 4,
                name = "Smart Debit",
        ...
        accountProductRepository.saveAll(listOf(basicCreditCard, standardCreditCard, premiumCreditCard, debitCard))
